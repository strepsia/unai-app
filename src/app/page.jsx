...
const SHOP_ITEMS = [
  { id: 1, name: 'Gorra Red Bull Racing', price: 50, image: 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=200&h=200&fit=crop', category: 'Gorras' },
  { id: 2, name: 'Camiseta Ferrari', price: 80, image: 'https://images.unsplash.com/photo-1529374255404-311a2a4f1fd9?w=200&h=200&fit=crop', category: 'Ropa' },
  { id: 3, name: 'Miniatura F1 1:43', price: 120, image: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=200&h=200&fit=crop', category: 'Coleccionables' },
  { id: 4, name: 'Poster GP Monaco', price: 30, image: 'https://images.unsplash.com/photo-1504817343863-5092a923803e?w=200&h=200&fit=crop', category: 'Decoración' },
  { id: 5, name: 'Llavero Mercedes', price: 15, image: 'https://images.unsplash.com/photo-1622547748225-3fc4abd2cca0?w=200&h=200&fit=crop', category: 'Accesorios' },
  { id: 6, name: 'Sudadera McLaren', price: 150, image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=200&h=200&fit=crop', category: 'Ropa' },
  { id: 7, name: 'Guantes Racing', price: 200, image: 'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=200&h=200&fit=crop', category: 'Equipamiento' },
  { id: 8, name: 'Volante Replica', price: 500, image: 'https://images.unsplash.com/photo-1547949003-9792a18a2601?w=200&h=200&fit=crop', category: 'Premium' },
  { id: 9, name: 'Casco Mini 1:2', price: 350, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=200&h=200&fit=crop', category: 'Coleccionables' },
  { id: 10, name: 'Bandera a Cuadros', price: 25, image: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=200&h=200&fit=crop', category: 'Decoración' },
];
              ...
              <div className="p-4 bg-black">
                <div className="grid grid-cols-4 gap-2">
                  <div className="text-center">
                    <div className="bg-gray-900 border border-gray-800 rounded py-3">
                      <p className="f1-wide text-3xl text-white">{countdown.days}</p>
                    </div>
                    <p className="text-gray-500 text-xs mt-2 uppercase tracking-wider">Días</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-gray-900 border border-gray-800 rounded py-3">
                      <p className="f1-wide text-3xl text-white">{countdown.hours}</p>
                    </div>
                    <p className="text-gray-500 text-xs mt-2 uppercase tracking-wider">Horas</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-gray-900 border border-gray-800 rounded py-3">
                      <p className="f1-wide text-3xl text-white">{countdown.minutes}</p>
                    </div>
                    <p className="text-gray-500 text-xs mt-2 uppercase tracking-wider">Min</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-gray-900 border border-[#E10600] rounded py-3">
                      <p className="f1-wide text-3xl text-[#E10600]">{countdown.seconds}</p>
                    </div>
        ...
        {races.map((race) => {
          ...
          return (
            ...
            >
              ...
              {/* Round number */}
              <div className={`w-8 text-center ${isNextRace ? 'text-[#E10600]' : 'text-gray-500'}`}>
